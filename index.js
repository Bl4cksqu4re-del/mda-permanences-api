...
app.get('/export/csv', async (req, res) => {
  ...
  try {
    ...
    const headers = ['id','date','type','adhérent','non-adhérent','ancien adhérent','structure','autres (ID)','déclaration','adjonction','juridique','social','comptable/fiscal','communication','adhésion','activité artistique','autres (motif)','mail','téléphone','CK','KR','LV','remarques/thèmes','suivi','newsletter','comment connu','créé le'];
...
app.listen(PORT, () => console.log(`MDA API running on port ${PORT}`));require('dotenv').config();
const express = require('express');
const { Pool } = require('pg');
const cors = require('cors');
